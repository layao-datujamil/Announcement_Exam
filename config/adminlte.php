...
return [
    ...
    */
    ...
    'menu' => [
        ...
        ['header' => 'account_settings', 'can' => 'Admin'],
        [
            'text' => 'profile',
            'url'  => '/users',
        ...
        'tempusdominus' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '/vendor/tempusdominus-bootstrap-4/js/moment.min.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
        ...
        'SummerNote' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => '/vendor/summernote/css/summernote-bs4.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '/vendor/summernote/js/summernote-bs4.min.js',
                ],
            ],
        ],
        'Select2' => [
