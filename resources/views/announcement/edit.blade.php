            ...
            <form action="/announcements/{{ $announcement->id }}" method="post">
                ...
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        value="{{ old('title') ?? $announcement->title }}" placeholder="Title" autofocus>
                                        @if($errors->has('title'))
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <textarea name="content" id="summernote" class="{{ $errors->has('content') ? 'is-invalid' : '' }}">{{ old('content') ?? $announcement->content }}</textarea>
...
<script>
    ...
    $(document).ready(function(){
        ...
        var currentDate = moment("{{ $announcement->startdate }}").toDate();
        var tommorowDate = moment("{{ $announcement->enddate }}").toDate();
        @if(old('startdate')!="")
